...
option(USE_RAM_FOR_BENCHMARK "Use RAM-optimized benchmark sources" ON)

if (USE_RAM_FOR_BENCHMARK)
    set(Beanchmark_Src
        ${CMAKE_CURRENT_SOURCE_DIR}/Core/Src/qsort_ram.c
        ${CMAKE_CURRENT_SOURCE_DIR}/Core/Src/fir_ram.c
    )
else()
    set(Beanchmark_Src
        ${CMAKE_CURRENT_SOURCE_DIR}/Core/Src/qsort.c
        ${CMAKE_CURRENT_SOURCE_DIR}/Core/Src/fir.c
    )
endif()
...
target_sources(${CMAKE_PROJECT_NAME} PRIVATE ${MX_Application_Src} ${Beanchmark_Src})
